...
export const AdaptableAgGridThird = () => {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexFlow: 'column', height: '100vh', '--ab-dashboard-header__background': 'green', } as React.CSSProperties}>
